...
public:
	...
	Fl_Slider*			m_constantAttenuation;
...
// static class members
	...
	static void cb_caSlides(Fl_Widget* o, void* v);
	static void cb_laSlides(Fl_Widget* o, void* v);
	static void cb_qaSlides(Fl_Widget* o, void* v);
